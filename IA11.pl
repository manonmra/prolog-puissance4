...
puissance3 :- initialiser2(G), premierPion(G,2,'O',_).
...
%IA Random
jouerCoup('NA',G):-
			write('Au tour de X de jouer.'), nl,
            repeat,
			random(1,8,C),
...
/* gagneEnUnCoup(_, _, 0, _):-fail.
gagneEnUnCoup(S, G, C, C3):-
                        (ajouterDansColonne(S, C, G, G2) ->
                            (victoire(S,G2)->
                                C3 is C,!;
                                C2 is C-1, gagneEnUnCoup(S, G, C2, C));
                            (C2 is C-1, gagneEnUnCoup(S, G, C2, C))
                        ),!. */

gagneEnUnCoup(_, _, 0, C2):- C2 is 0, !.
gagneEnUnCoup(S, G, C, C2):- ajouterDansColonne(S,C,G,G2), victoire(S,G2), C2 is C, !.
gagneEnUnCoup(S, G, C, C2):- C3 is C-1, gagneEnUnCoup(S, G, C3, C2).

%implémentation de l'IA1 (si possible cherche à jouer au milieu de la grille)
ia1(S, G, G2, C):-gagneEnUnCoup(S, G, C, C2), \+ C2 is 0, ajouterDansColonne(S, C2, G, G2).
...
ia2(S, G, G2, _):-ajouterDansColonne(S, 4, G, G2).
ia2(S, G, G2, _):-ajouterDansColonne(S, 5, G, G2).
ia2(S, G, G2, _):-ajouterDansColonne(S, 3, G, G2).
ia2(S, G, G2, _):-ajouterDansColonne(S, 6, G, G2).
ia2(S, G, G2, _):-ajouterDansColonne(S, 2, G, G2).
ia2(S, G, G2, _):-ajouterDansColonne(S, 7, G, G2).
ia2(S, G, G2, _):-ajouterDansColonne(S, 1, G, G2).

pionDessous(_,0,S,H):- append(_,['_','_','_',S|_],H),!.
pionDessous(_,0,S,H):- append(_,['_','_',S,S|_],H),!.
pionDessous([T1|T2],C,S,_):- C2 is C-1, pionDessous(T2,C2,S,T1).

premierPion(_,0,S,H):- append(['_','_','_'],['_','_','_'],H),!.
%premierPion(_,0,S,H):- H is ['_','_','_','_','_','_'],!.
premierPion([T1|T2],C,S,_):- C2 is C-1, premierPion(T2,C2,S,T1).

%pionDessous(S, G, C):- trouverColonne(G,C,_,H2), append(_,['_','_','_',S|_],H2),!.


%implémentation de l'IA3 (si possible cherche à jouer au milieu de la grille + Jouer au dessus d'un de nos pions)
ia3(S, G, G2, C):-gagneEnUnCoup(S, G, C, C2), \+ C2 is 0, ajouterDansColonne(S, C2, G, G2).
ia3(S, G, G2, _):-pionDessous(G,4,S,_), ajouterDansColonne(S, 4, G, G2), nePerdPasAuProchainCoup(S, G2,7).
ia3(S, G, G2, _):-pionDessous(G,5,S,_), ajouterDansColonne(S, 5, G, G2), nePerdPasAuProchainCoup(S, G2,7).
ia3(S, G, G2, _):-pionDessous(G,3,S,_), ajouterDansColonne(S, 3, G, G2), nePerdPasAuProchainCoup(S, G2,7).
ia3(S, G, G2, _):-pionDessous(G,6,S,_), ajouterDansColonne(S, 6, G, G2), nePerdPasAuProchainCoup(S, G2,7).
ia3(S, G, G2, _):-pionDessous(G,2,S,_), ajouterDansColonne(S, 2, G, G2), nePerdPasAuProchainCoup(S, G2,7).
ia3(S, G, G2, _):-pionDessous(G,7,S,_), ajouterDansColonne(S, 7, G, G2), nePerdPasAuProchainCoup(S, G2,7).
ia3(S, G, G2, _):-pionDessous(G,1,S,_), ajouterDansColonne(S, 1, G, G2), nePerdPasAuProchainCoup(S, G2,7).

ia3(S, G, G2, _):-premierPion(G,4,S,_), ajouterDansColonne(S, 4, G, G2), nePerdPasAuProchainCoup(S, G2,7).
ia3(S, G, G2, _):-premierPion(G,5,S,_), ajouterDansColonne(S, 5, G, G2), nePerdPasAuProchainCoup(S, G2,7).
ia3(S, G, G2, _):-premierPion(G,3,S,_), ajouterDansColonne(S, 3, G, G2), nePerdPasAuProchainCoup(S, G2,7).
ia3(S, G, G2, _):-premierPion(G,6,S,_), ajouterDansColonne(S, 6, G, G2), nePerdPasAuProchainCoup(S, G2,7).
ia3(S, G, G2, _):-premierPion(G,2,S,_), ajouterDansColonne(S, 2, G, G2), nePerdPasAuProchainCoup(S, G2,7).
ia3(S, G, G2, _):-premierPion(G,7,S,_), ajouterDansColonne(S, 7, G, G2), nePerdPasAuProchainCoup(S, G2,7).
ia3(S, G, G2, _):-premierPion(G,1,S,_), ajouterDansColonne(S, 1, G, G2), nePerdPasAuProchainCoup(S, G2,7).


%si on a pas de pion bien placé
ia3(S, G, G2, _):-ajouterDansColonne(S, 4, G, G2), nePerdPasAuProchainCoup(S, G2,7).
ia3(S, G, G2, _):-ajouterDansColonne(S, 5, G, G2), nePerdPasAuProchainCoup(S, G2,7).
ia3(S, G, G2, _):-ajouterDansColonne(S, 3, G, G2), nePerdPasAuProchainCoup(S, G2,7).
ia3(S, G, G2, _):-ajouterDansColonne(S, 6, G, G2), nePerdPasAuProchainCoup(S, G2,7).
ia3(S, G, G2, _):-ajouterDansColonne(S, 2, G, G2), nePerdPasAuProchainCoup(S, G2,7).
ia3(S, G, G2, _):-ajouterDansColonne(S, 7, G, G2), nePerdPasAuProchainCoup(S, G2,7).
ia3(S, G, G2, _):-ajouterDansColonne(S, 1, G, G2), nePerdPasAuProchainCoup(S, G2,7).

%Si on perd
ia3(S, G, G2, _):-ajouterDansColonne(S, 4, G, G2).
ia3(S, G, G2, _):-ajouterDansColonne(S, 5, G, G2).
ia3(S, G, G2, _):-ajouterDansColonne(S, 3, G, G2).
ia3(S, G, G2, _):-ajouterDansColonne(S, 6, G, G2).
ia3(S, G, G2, _):-ajouterDansColonne(S, 2, G, G2).
ia3(S, G, G2, _):-ajouterDansColonne(S, 7, G, G2).
ia3(S, G, G2, _):-ajouterDansColonne(S, 1, G, G2).
...
evaluerEtChoisir([Coup|Coups], Grille, Profondeur, MaxMin, Record, MeilleurCoup, Joueur):- 
	ajouterDansColonne(Joueur, Coup, Grille, Grille1), % on simule un coup et on stocke la grille hypothétique dans Grille1
	minmax(Profondeur, Grille1, MaxMin, Coup, Valeur, Joueur), % renvoie si jouer en Coup est une bonne idée
	%ici, parfois, on finit d'explorer tout un coté de l'arbre
	maj(Coup, Valeur, Record, Record1),   %% est-ce que jouer en Coup devient notre meilleure idée
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%nl, write('mon record quand je joue à la colonne '),write(Coup), write(' est :'),write(Record1), 
	evaluerEtChoisir(Coups, Grille, Profondeur, MaxMin, Record1, MeilleurCoup, Joueur). % essayons de jouer autre part
evaluerEtChoisir([], Grille, Profondeur, MaxMin, Record, Record, Joueur).	 %notre meilleure idée est notre record actuel

minmax(0, Grille, MaxMin, Coup, Valeur, Joueur):-
	valeur(Grille, Coup, V, Joueur), % permet d'évaluer une grille : résultat dans V
	Valeur is V*MaxMin.
	%nl,write('Coup : '),write(Coup),
	%nl, write('Grille'), write(Grille),
	%nl,write('Valeur:'),write(Valeur). 
minmax(Profondeur, Grille, MaxMin, Coup, Valeur, Joueur):-
	...
	coupsPossibles(Grille, Coups),
	Profondeur1 is Profondeur-1,
	MinMax is -MaxMin,
	adversaire(Joueur,AutreJoueur),
	evaluerEtChoisir(Coups, Grille, Profondeur1, MinMax, (0,-1001),(Coup, Valeur), AutreJoueur).
	%write('VALEUR :'), write(Valeur). 
...
valeur(Grille, Coup, V, Joueur):-
	...
	pointsDePosition(Grille, Coup, PointsDeBlocage, ProchainJoueur),
	V is Points1+PointsDeBlocage/2.
	%nl,  write('POINTS : '), write(V).

creerUneListeTest([1,2,3,4,5,6,7]).
testPointsDePosition(X) :- initialiser(Grille), creerUneListeTest(Liste),evaluerEtChoisir(Liste, Grille, 0, 1, (0,-1001), MeilleurCoup, 'O'), nl,write('Meilleur coup : '),write(MeilleurCoup).
